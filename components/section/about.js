...
export default function About() {
  let umur = sAge("Feb 26 2003");
  let [gh, setGh] = useState('Fetching...');
  useEffect(() => {
    (async() => {
      try {
        const res = await fetch("https://api.github.com/users/buttafraz22");
          ...
          <section id="about" className="text-black py-20">
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="ml-10 mr-10 pt-10">
                ...
                ></div>
                <p className="mt-2">
                  {`I live in Lahore, Pakistan. My full name is Afraz
                  Butt, no middle name(s). I'm ${umur} years old. A Software
                  Engineering student, I have known Programming since 2021.
                  Additionally, I am a trainee Machine Learning developer 
                  and have some experience building models in tensorflow. I also
                  have some development experience in web frameworks react, html, css and js.`}
                </p>
                <p className="mt-5">
                  A Little Story, In the past, I was fascinated with web apps as
                  a career, and also liked game development. But now, I&apos;m dedicating
                  my full time to learning the intricacies of machine learning. I don&apos;t
                ...
                <p className="mt-5">
                  ...
                  templates or even learning materials of courses. There
                  are several serious projects but now they are rarely developed
                  due to conflicts with school work. <em >
                  I am also an active Microsoft Learn
                  Student Ambassador, onboarded in the October 23&apos; cohort.</em>
                </p>
